...
I  re-implemented the filtering stage with box-level CLIP scoring (as in the paper), while retaining DINOv2 global feature computation, and will re-evaluate its effectiveness in the pipeline next week.
